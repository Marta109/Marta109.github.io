    ...
    const elements = data.map((el) =>
      UI.createElement('div', { class: 'card', id: el.id }, [
        UI.createElement('img', {
          src: 'https://avatars.mds.yandex.net/i?id=a312755a937797721e28e1c2d119f010_l-5175041-images-thumbs&n=13',
        ...
        UI.createElement('div', { class: 'card-body' }, [
          ...
          UI.createElement('div', { class: 'card-descr h5' }, `${el.username}`),
          UI.createElement('div', { class: 'card-descr h5' }, `${el.email}`),
        ]),
      ]),
    );
